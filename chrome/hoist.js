   ...
   for (const mutationRecord of mutations){
       if (mutationRecord.addedNodes.length > 0) {
           for (const addedNode of mutationRecord.addedNodes){
               if (addedNode.matches('span[role="tooltip"]') && addedNode.textContent.trimStart().startsWith('Owned by you')){
...
githubCodeOwnerHoistNodes(
    [...document.querySelectorAll('span[role="tooltip"]')]
